...
if (! class_exists('Classic_Editor') ) :
    class Classic_Editor
    {
        ...
        public static function register_settings()
        {
            ...
            register_setting(
                'writing', 'classic-editor-replace', array(
                'sanitize_callback' => array( __CLASS__, 'validate_option_editor' ),
                ) 
            );

            register_setting(
                'writing', 'classic-editor-allow-users', array(
        ...
        {
            if (isset($_POST['classic-editor-user-settings']) 
        ...
        {
            if (isset($_POST['classic-editor-network-settings']) 
        ...
        public static function choose_editor( $use_block_editor, $post )
        {
            ...
            if (empty($post->ID) || $post->post_status === 'auto-draft' ) {
                if (( $settings['editor'] === 'classic' && ! isset($_GET['classic-editor__forget']) )   // Add New
